...
frappe.ui.form.on('Attendance Regularize', {
	attendance_date(frm){
		frappe.call({
			method:'johoku.johoku.doctype.attendance_regularize.attendance_regularize.get_assigned_shift_details',
			args:{
		...
		frappe.call({
			method:'johoku.johoku.doctype.attendance_regularize.attendance_regularize.get_attendance',
			args:{
				emp:frm.doc.employee,
				att_date:frm.doc.attendance_date
			},
		...
		frappe.call({
			method:'johoku.johoku.doctype.attendance_regularize.attendance_regularize.attendance_marked',
			args:{
				emp:frm.doc.employee,
				att_date:frm.doc.attendance_date,
			},
