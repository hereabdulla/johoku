...
def get_columns():
    columns = [
        _("Employee") + ":Data:100",_("Employee Name") + ":Data:150",_("Department") + ":Data:110",_("Attendance Date") + ":Data:140",_("Shift") + ":Data:60",_("Shift Time") + ":Data:100",_("In Time") + ":Data:100",_("Late Time") + ":Data:100"
    ]
    return columns
