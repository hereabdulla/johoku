...
def get_columns(filters):
    columns = []
    columns += [
        _("Employee ID") + ":Data/:150",_("Employee Name") + ":Data/:200",_("Department") + ":Data/:150",_("Designation") + ":Data/:150",_("DOJ") + ":Date/:100",_("") + ":Data/:150",
    ]
    ...
    for emp in employees:
        ...
        for date in dates:
            ...
            if att:
                ...
                # if att[7]:
                #     over_time_hours = over_time_hours + int(att[8])
        ...
        row1.extend([total_present,total_half_day,total_absent,total_weekoff,total_holiday,total_paid_leave,total_ot,total_wot,total_hot,total_days or ""])
        row2.extend(['-','-','-','-','-','-','-','-','-','-','-','-','-','-'])
        row3.extend(['-','-','-','-','-','-','-','-','-','-','-','-','-','-'])
        row4.extend(['-','-','-','-','-','-','-','-','-','-','-','-','-','-'])
        row5.extend(['-','-','-','-','-','-','-','-','-','-','-','-','-','-'])
